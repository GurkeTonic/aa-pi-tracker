...
AA_PI_TRACKER_EXPIRY_WARN_HOURS = getattr(
    settings, "AA_PI_TRACKER_EXPIRY_WARN_HOURS", 24
)

# Days to keep PiMaintenanceLog rows before the daily cleanup task deletes them
AA_PI_TRACKER_MAINT_LOG_RETENTION_DAYS = getattr(
    settings, "AA_PI_TRACKER_MAINT_LOG_RETENTION_DAYS", 90
)
