...
PLANET_TYPE_P0: dict[int, list[str]] = {
    ...
    13:    ["Base Metals", "Aqueous Liquids", "Ionic Solutions", "Noble Gas", "Reactive Gas"],                  # Gas
    ...
    2016:  ["Microorganisms", "Base Metals", "Noble Metals", "Carbon Compounds", "Aqueous Liquids"],            # Barren
...
# type and are uniform per tier. ``get_poco_base_costs()`` reads them live from
...
_TIER_REPRESENTATIVE = {0: "Base Metals", 1: "Bacteria", 2: "Coolant", 3: "Robotics", 4: "Broadcast Node"}
