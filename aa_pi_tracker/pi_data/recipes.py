...
ESI_SCHEMATIC_NAMES = {
    ...
    # PI 2.0 additional schematic IDs (same products, new IDs)
    ...
    86: "Test Cultures",
    96: "Supercomputers",
    104: "Biotech Research Reports",
    111: "Cryoprotectant Solution",
    119: "Wetware Mainframe",
    124: "Oxygen",
    126: "Reactive Metals",
    127: "Precious Metals",
    129: "Chiral Structures",
    134: "Biofuels",
}

# Production recipes keyed by product name.
...
# Tier 3: Advanced Industry Facility (10 P2 each → 3 P3 / 60 min) =  3 P3/h per factory
# Tier 4: High-Tech Production Plant (6 P3 each  → 1 P4 / 60 min) =  1 P4/h per factory (Barren/Temperate only)
SCHEMATICS = {
    # ── P1 ──────────────────────────────────────────────────────────────────
    "Bacteria":            {"tier": 1, "output_qty": 20, "cycle_time": 1800, "inputs": {"Microorganisms": 3000}},
    ...
    "Industrial Fibers":   {"tier": 1, "output_qty": 20, "cycle_time": 1800, "inputs": {"Autotrophs": 3000}},
    ...
    # ── P2 ──────────────────────────────────────────────────────────────────
    "Biocells":                       {"tier": 2, "output_qty": 5, "cycle_time": 3600, "inputs": {"Biofuels": 40, "Precious Metals": 40}},
    ...
    "Livestock":                      {"tier": 2, "output_qty": 5, "cycle_time": 3600, "inputs": {"Biofuels": 40, "Proteins": 40}},
    "Mechanical Parts":               {"tier": 2, "output_qty": 5, "cycle_time": 3600, "inputs": {"Reactive Metals": 40, "Precious Metals": 40}},
    ...
    "Oxides":                         {"tier": 2, "output_qty": 5, "cycle_time": 3600, "inputs": {"Oxidizing Compound": 40, "Oxygen": 40}},
    "Polyaramids":                    {"tier": 2, "output_qty": 5, "cycle_time": 3600, "inputs": {"Industrial Fibers": 40, "Oxidizing Compound": 40}},
    "Polytextiles":                   {"tier": 2, "output_qty": 5, "cycle_time": 3600, "inputs": {"Biofuels": 40, "Industrial Fibers": 40}},
    "Rocket Fuel":                    {"tier": 2, "output_qty": 5, "cycle_time": 3600, "inputs": {"Electrolytes": 40, "Plasmoids": 40}},
    "Silicate Glass":                 {"tier": 2, "output_qty": 5, "cycle_time": 3600, "inputs": {"Oxidizing Compound": 40, "Silicon": 40}},
    "Superconductors":                {"tier": 2, "output_qty": 5, "cycle_time": 3600, "inputs": {"Plasmoids": 40, "Water": 40}},
    "Supertensile Plastics":          {"tier": 2, "output_qty": 5, "cycle_time": 3600, "inputs": {"Biomass": 40, "Oxygen": 40}},
    ...
    "Transmitter":                    {"tier": 2, "output_qty": 5, "cycle_time": 3600, "inputs": {"Chiral Structures": 40, "Plasmoids": 40}},
    ...
    # ── P3 ──────────────────────────────────────────────────────────────────
    "Biotech Research Reports":      {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Construction Blocks": 10, "Livestock": 10, "Nanites": 10}},
    "Camera Drones":                 {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Rocket Fuel": 10, "Silicate Glass": 10}},
    "Condensates":                   {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Coolant": 10, "Oxides": 10}},
    "Cryoprotectant Solution":       {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Fertilizer": 10, "Synthetic Oil": 10, "Test Cultures": 10}},
    "Data Chips":                    {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Microfiber Shielding": 10, "Supertensile Plastics": 10}},
    "Gel-Matrix Biopaste":           {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Biocells": 10, "Oxides": 10, "Superconductors": 10}},
    "Guidance Systems":              {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Transmitter": 10, "Water-Cooled CPU": 10}},
    "Hazmat Detection Systems":      {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Polytextiles": 10, "Transmitter": 10, "Viral Agent": 10}},
    "Hermetic Membranes":            {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Genetically Enhanced Livestock": 10, "Polyaramids": 10}},
    "High-Tech Transmitters":        {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Polyaramids": 10, "Transmitter": 10}},
    "Industrial Explosives":         {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Fertilizer": 10, "Polytextiles": 10}},
    ...
    "Synthetic Synapses":            {"tier": 3, "output_qty": 3, "cycle_time": 3600, "inputs": {"Supertensile Plastics": 10, "Test Cultures": 10}},
    ...
    # ── P4 ──────────────────────────────────────────────────────────────────
    "Broadcast Node":              {"tier": 4, "output_qty": 1, "cycle_time": 3600, "inputs": {"Data Chips": 6, "High-Tech Transmitters": 6, "Neocoms": 6}},
    ...
    "Nano-Factory":                {"tier": 4, "output_qty": 1, "cycle_time": 3600, "inputs": {"Industrial Explosives": 6, "Reactive Metals": 40, "Ukomi Superconductors": 6}},
    "Organic Mortar Applicators":  {"tier": 4, "output_qty": 1, "cycle_time": 3600, "inputs": {"Bacteria": 40, "Condensates": 6, "Robotics": 6}},
    "Recursive Computing Module":  {"tier": 4, "output_qty": 1, "cycle_time": 3600, "inputs": {"Guidance Systems": 6, "Synthetic Synapses": 6, "Transcranial Microcontrollers": 6}},
    ...
    "Sterile Conduits":            {"tier": 4, "output_qty": 1, "cycle_time": 3600, "inputs": {"Smartfab Units": 6, "Vaccines": 6, "Water": 40}},
