...
SCHEMATICS = {
    ...
    "Construction Blocks": {
        ...
        "output_qty": 5,
        "cycle_time": 3600,
        "inputs": {"Reactive Metals": 40, "Toxic Metals": 40},
    },
    "Consumer Electronics": {
        "tier": 2,
        "output_qty": 5,
        "cycle_time": 3600,
        "inputs": {"Chiral Structures": 40, "Toxic Metals": 40},
    },
    "Coolant": {
        "tier": 2,
        "output_qty": 5,
    ...
    "Enriched Uranium": {
        ...
        "output_qty": 5,
        "cycle_time": 3600,
        "inputs": {"Precious Metals": 40, "Toxic Metals": 40},
    },
    "Fertilizer": {
        "tier": 2,
        "output_qty": 5,
    ...
    "Microfiber Shielding": {
        ...
        "output_qty": 5,
        "cycle_time": 3600,
        "inputs": {"Industrial Fibers": 40, "Silicon": 40},
    },
    "Miniature Electronics": {
        "tier": 2,
        "output_qty": 5,
        "cycle_time": 3600,
        "inputs": {"Chiral Structures": 40, "Silicon": 40},
    },
    "Nanites": {
        "tier": 2,
        "output_qty": 5,
        "cycle_time": 3600,
        "inputs": {"Bacteria": 40, "Reactive Metals": 40},
    },
    "Oxides": {
        "tier": 2,
        "output_qty": 5,
    ...
    "Polyaramids": {
        ...
        "output_qty": 5,
        "cycle_time": 3600,
        "inputs": {"Industrial Fibers": 40, "Oxidizing Compound": 40},
    },
    "Polytextiles": {
        "tier": 2,
        "output_qty": 5,
    ...
    "Cryoprotectant Solution": {
        ...
        "output_qty": 3,
        "cycle_time": 3600,
        "inputs": {"Fertilizer": 10, "Synthetic Oil": 10, "Test Cultures": 10},
    },
    "Data Chips": {
        "tier": 3,
        "output_qty": 3,
        "cycle_time": 3600,
        "inputs": {"Microfiber Shielding": 10, "Supertensile Plastics": 10},
    },
    "Gel-Matrix Biopaste": {
        "tier": 3,
        "output_qty": 3,
        "cycle_time": 3600,
        "inputs": {"Biocells": 10, "Oxides": 10, "Superconductors": 10},
    },
    "Guidance Systems": {
        "tier": 3,
        "output_qty": 3,
        "cycle_time": 3600,
        "inputs": {"Transmitter": 10, "Water-Cooled CPU": 10},
    },
    "Hazmat Detection Systems": {
        "tier": 3,
        "output_qty": 3,
        "cycle_time": 3600,
        "inputs": {"Polytextiles": 10, "Transmitter": 10, "Viral Agent": 10},
    },
    "Hermetic Membranes": {
        "tier": 3,
        "output_qty": 3,
        "cycle_time": 3600,
        "inputs": {"Genetically Enhanced Livestock": 10, "Polyaramids": 10},
    },
    "High-Tech Transmitters": {
        "tier": 3,
        "output_qty": 3,
        "cycle_time": 3600,
        "inputs": {"Polyaramids": 10, "Transmitter": 10},
    },
    ...
    "Planetary Vehicles": {
        ...
        "inputs": {
            "Mechanical Parts": 10,
            "Miniature Electronics": 10,
            "Supertensile Plastics": 10,
        },
    },
    "Robotics": {
        "tier": 3,
    ...
    "Smartfab Units": {
        ...
        "output_qty": 3,
        "cycle_time": 3600,
        "inputs": {"Construction Blocks": 10, "Miniature Electronics": 10},
    },
    "Supercomputers": {
        "tier": 3,
        "output_qty": 3,
        "cycle_time": 3600,
        "inputs": {"Consumer Electronics": 10, "Coolant": 10, "Water-Cooled CPU": 10},
    },
    "Synthetic Synapses": {
        "tier": 3,
        "output_qty": 3,
    ...
    "Broadcast Node": {
        ...
        "output_qty": 1,
        "cycle_time": 3600,
        "inputs": {"Data Chips": 6, "High-Tech Transmitters": 6, "Neocoms": 6},
    },
    "Integrity Response Drones": {
        ...
        "cycle_time": 3600,
        "inputs": {
            "Gel-Matrix Biopaste": 6,
            "Hazmat Detection Systems": 6,
    ...
    "Nano-Factory": {
        ...
        "cycle_time": 3600,
        "inputs": {
            "Industrial Explosives": 6,
            "Reactive Metals": 40,
            "Ukomi Superconductors": 6,
        },
    },
    "Organic Mortar Applicators": {
        ...
        "output_qty": 1,
        "cycle_time": 3600,
        "inputs": {"Bacteria": 40, "Condensates": 6, "Robotics": 6},
    },
    "Recursive Computing Module": {
        ...
        "inputs": {
            ...
            "Transcranial Microcontrollers": 6,
        },
    },
    "Self-Harmonizing Power Core": {
        ...
        "output_qty": 1,
        "cycle_time": 3600,
        "inputs": {"Camera Drones": 6, "Hermetic Membranes": 6, "Nuclear Reactors": 6},
    },
    "Sterile Conduits": {
        "tier": 4,
        "output_qty": 1,
        "cycle_time": 3600,
        "inputs": {"Smartfab Units": 6, "Vaccines": 6, "Water": 40},
    },
    "Wetware Mainframe": {
        "tier": 4,
        "output_qty": 1,
        "cycle_time": 3600,
        "inputs": {
            "Biotech Research Reports": 6,
            "Cryoprotectant Solution": 6,
            "Supercomputers": 6,
        },
    },
}
