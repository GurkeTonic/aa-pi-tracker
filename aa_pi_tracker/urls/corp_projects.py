...
urlpatterns = [
    ...
    path("<int:pk>/participants/", views.corp_project_set_participants, name="corp_project_set_participants"),
    path("<int:pk>/add-objective/", views.corp_project_add_objective, name="corp_project_add_objective"),
    path("objective/<int:pk>/delete/", views.corp_project_delete_objective, name="corp_project_delete_objective"),
]
